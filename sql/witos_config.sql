...
*/
DROP DATABASE IF EXISTS `witos_config`;

CREATE DATABASE  `witos_config` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'application-dev.yml', 'DEFAULT_GROUP', 'spring:\r\n  autoconfigure:\r\n    exclude: com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceAutoConfigure\r\n  mvc:\r\n    pathmatch:\r\n      matching-strategy: ant_path_matcher\r\n# mail配置\r\n  mail:\r\n    # 配置 SMTP 服务器地址\r\n    host: smtpdm.aliyun.com\r\n    # 发送者邮箱\r\n    username: xxxxxx@163.com\r\n    # 配置密码，注意不是真正的密码，而是刚刚申请到的授权码\r\n    password: xxxxx\r\n    # 端口号465或587\r\n    port: 465\r\n    # 默认的邮件编码为UTF-8\r\n    default-encoding: UTF-8\r\n    # 配置SSL 加密工厂\r\n    properties:\r\n      mail:\r\n        smtp:\r\n          ssl:\r\n            enable: true\r\n          socketFactoryClass: javax.net.ssl.SSLSocketFactory\r\n        #表示开启 DEBUG 模式，这样，邮件发送过程的日志会在控制台打印出来，方便排查错误\r\n        debug: true\r\n# feign 配置\r\nfeign:\r\n  sentinel:\r\n    enabled: true\r\n  okhttp:\r\n    enabled: true\r\n  httpclient:\r\n    enabled: false\r\n  client:\r\n    config:\r\n      default:\r\n        connectTimeout: 10000\r\n        readTimeout: 10000\r\n      witos-job:\r\n        connectTimeout: 100000\r\n        readTimeout: 100000\r\n  compression:\r\n    request:\r\n      enabled: true\r\n    response:\r\n      enabled: true\r\n\r\n# 暴露监控端点\r\nmanagement:\r\n  endpoints:\r\n    web:\r\n      exposure:\r\n        include: \'*\'\r\nlogging:\r\n  level:\r\n    org.springframework: info\r\n    com.witos: debug\r\n  #log日志文件配置\r\n  file_basePath: ./logs\r\n  file_prefix: ${spring.application.name}\r\nmybatis-plus:\r\n  mapper-locations: classpath*:mapper/**/*.xml\r\n  global-config:\r\n    banner: false\r\n    refresh-mapper: true\r\n    db-config:\r\n      id-type: auto\r\n      table-underline: true\r\n      logic-delete-value: 1\r\n      logic-not-delete-value: 0\r\n  configuration:\r\n    map-underscore-to-camel-case: true\r\n  type-handlers-package: com.witos.common.mybatisplus\r\nwitos:\r\n  #多租户配置\r\n  tenant:\r\n    ignore-tables:\r\n      #系统表\r\n      - sys_config\r\n      - gen_table\r\n      - gen_table_column\r\n      - sys_dict_data\r\n      - sys_dict_type\r\n      - sys_menu\r\n      - sys_tenant\r\n      - sys_tenant_package\r\n      - sys_oper_log\r\n      - sys_logininfor\r\n      - branch_table\r\n      - global_table\r\n      - lock_table\r\n      - undo_log\r\n      - xxl_job_group\r\n      - xxl_job_info\r\n      - xxl_job_lock\r\n      - xxl_job_log\r\n      - xxl_job_log_report\r\n      - xxl_job_logglue\r\n      - xxl_job_registry\r\n      - xxl_job_user\r\n      #自定义表\r\n# 短信服务\r\naliyun:\r\n  endpoint: cn-shanghai\r\n  accessKeyId:  \r\n  accessKeySecret: \r\n  signName:  \r\n  templateCode: \r\n# 本地文件上传    \r\nfile:\r\n  domain: http://127.0.0.1:39300\r\n  path: /home/upload\r\n  prefix: /documents\r\n', '486f300db580135651a697a578516fd0', '2020-05-20 12:00:00', '2023-05-25 11:36:09', 'nacos', '0:0:0:0:0:0:0:1', '', '', '通用配置', 'null', 'null', 'yaml', 'null', '');
INSERT INTO `config_info` VALUES (2, 'witos-gateway-dev.yml', 'DEFAULT_GROUP', 'spring:\n  redis:\n    host: witos-redis\n    port: 6379\n#    password:\n    timeout: 1000 # 连接超时时间（毫秒）\n    jedis:\n      pool:\n        max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\n        max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-idle: 8 # 连接池中的最大  空闲连接\n        min-idle: 0 # 连接池中的最小空闲连接\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: witos-auth\n          uri: lb://witos-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n            # 验证码处理\n            - CacheRequestFilter\n            - ValidateCodeFilter\n            - StripPrefix=1\n        # 代码生成\n        - id: witos-gen\n          uri: lb://witos-gen\n          predicates:\n            - Path=/code/**\n          filters:\n            - StripPrefix=1\n        # 系统模块\n        - id: witos-system\n          uri: lb://witos-system\n          predicates:\n            - Path=/system/**\n          filters:\n            - StripPrefix=1\n        # 文件服务\n        - id: witos-file\n          uri: lb://witos-file\n          predicates:\n            - Path=/file/**\n          filters:\n            - StripPrefix=1\n        # 监控模块\n        - id: witos-monitor\n          uri: lb://witos-monitor\n          predicates:\n            - Path=/monitor/**\n          filters:\n            - StripPrefix=1\n        # 定时模块\n        - id: witos-job\n          uri: lb://witos-job\n          predicates:\n            - Path=/job/**\n          filters:\n            - StripPrefix=1\n        # 样例模块\n        - id: witos-demo\n          uri: lb://witos-demo\n          predicates:\n            - Path=/demo/**\n          filters:\n            - StripPrefix=1\n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n      - /system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - /auth/logout\n      - /auth/login\n      - /auth/register\n      - /*/v2/api-docs\n      - /csrf\n      - /job/api/callback\n      - /job/api/registry\n      - /job/api/registryRemove\n      - /file/documents/**', '5a845475cebf39dce590f84fe20ea9e9', '2020-05-14 14:17:55', '2023-07-22 14:18:21', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (3, 'witos-auth-dev.yml', 'DEFAULT_GROUP', 'spring: \n  redis:\n    host: witos-redis\n    port: 6379\n#    password:\n    timeout: 1000 # 连接超时时间（毫秒）\n    jedis:\n      pool:\n        max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\n        max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\n        max-idle: 8 # 连接池中的最大  空闲连接\n        min-idle: 0 # 连接池中的最小空闲连接\nfeign:\n  sentinel:\n    enabled: true\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  client:\n    config:\n      default:\n        connectTimeout: 10000\n        readTimeout: 10000\n        #loggerLevel: full\n        requestInterceptors: com.witos.common.security.feign.FeignRequestInterceptor', '75ba050d90558dd0a07d9ba58b427998', '2022-11-28 22:04:14', '2022-11-28 22:19:59', 'nacos', '127.0.0.1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (4, 'witos-monitor-dev.yml', 'DEFAULT_GROUP', '# spring配置\nspring: \n  redis:\n    host: witos-redis\n    port: 6379\n#    password:\n    timeout: 1000 # 连接超时时间（毫秒）\n    # jedis:\n    #   pool:\n    #     max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\n    #     max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\n    #     max-idle: 8 # 连接池中的最大  空闲连接\n    #     min-idle: 0 # 连接池中的最小空闲连接\n    lettuce:\n      pool:\n        max-active: 20\n        max-wait: 500ms\n        max-idle: 10\n        min-idle: 2\n  datasource: \n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://witos-mysql:3306/witos_platform?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: \n# swagger配置\nswagger:\n  title: 代码生成接口文档\n  license: Powered By witos\n  licenseUrl: https://witos.cn\n# seata配置\nseata:\n  # 默认关闭，如需启用spring.datasource.dynami.seata需要同时开启\n  enabled: false\n  # Seata 应用编号，默认为 ${spring.application.name}\n  application-id: ${spring.application.name}\n  # Seata 事务组编号，用于 TC 集群名\n  tx-service-group: ${spring.application.name}-group\n  # 关闭自动代理\n  enable-auto-data-source-proxy: false\n  # 服务配置项\n  service:\n    # 虚拟组和分组的映射\n    vgroup-mapping:\n      witos-system-group: default\n  config:\n    type: nacos\n    nacos:\n      serverAddr: witos-nacos:8848\n      group: SEATA_GROUP\n      namespace:\n  registry:\n    type: nacos\n    nacos:\n      application: seata-server\n      server-addr: witos-nacos:8848\n      namespace:', '07b59d428a34e682083a7b693e1ae993', '2022-11-28 22:04:14', '2022-11-28 22:21:04', 'nacos', '127.0.0.1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (5, 'witos-system-dev.yml', 'DEFAULT_GROUP', '# spring配置\r\nspring:\r\n  redis:\r\n    host: witos-redis\r\n    port: 6379\r\n#    password:\r\n    timeout: 1000 # 连接超时时间（毫秒）\r\n    jedis:\r\n      pool:\r\n        max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\r\n        max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-idle: 8 # 连接池中的最大  空闲连接\r\n        min-idle: 0 # 连接池中的最小空闲连接\r\n  datasource:\r\n    druid:\r\n      stat-view-servlet:\r\n        enabled: true\r\n        loginUsername: admin\r\n        loginPassword: 123456\r\n    dynamic:\r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 50\r\n        maxActive: 100\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 300000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 50\r\n        filters: stat,slf4j\r\n        connectionProperties: druid.stat.mergeSql=true;druid.stat.slowSqlMillis=500\r\n      datasource:\r\n          # 主库数据源\r\n          master:\r\n            driver-class-name: com.mysql.cj.jdbc.Driver\r\n            url: jdbc:mysql://witos-mysql:3306/witos_platform?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\r\n            username: root\r\n            password: 123456\r\nseata:\r\n  # 默认关闭，如需启用spring.datasource.dynami.seata需要同时开启\r\n  enabled: false\r\n  # Seata 应用编号，默认为 ${spring.application.name}\r\n  application-id: ${spring.application.name}\r\n  # Seata 事务组编号，用于 TC 集群名\r\n  tx-service-group: ${spring.application.name}-group\r\n  # 关闭自动代理\r\n  enable-auto-data-source-proxy: false\r\n  # 服务配置项\r\n  service:\r\n    # 虚拟组和分组的映射\r\n    vgroup-mapping:\r\n      witos-system-group: default\r\n  config:\r\n    type: nacos\r\n    nacos:\r\n      serverAddr: witos-nacos:8848\r\n      group: SEATA_GROUP\r\n      namespace:\r\n  registry:\r\n    type: nacos\r\n    nacos:\r\n      application: seata-server\r\n      server-addr: witos-nacos:8848\r\n      namespace:\r\n\r\n# mybatis配置\r\n# mybatis:\r\n#     搜索指定包别名\r\n#     typeAliasesPackage: com.witos.system\r\n#     配置mapper的扫描，找到所有的mapper.xml映射文件\r\n#     mapperLocations: classpath:mapper/**/*.xml\r\n\r\n# swagger配置\r\nswagger:\r\n  title: 系统模块接口文档\r\n  license: Powered By witos\r\n  licenseUrl: https://witos.vip\r\nfeign:\r\n  sentinel:\r\n    enabled: true\r\n  okhttp:\r\n    enabled: true\r\n  httpclient:\r\n    enabled: false\r\n  client:\r\n    config:\r\n      default:\r\n        connectTimeout: 10000\r\n        readTimeout: 10000\r\n        loggerLevel: full\r\n        requestInterceptors: com.witos.common.security.feign.FeignRequestInterceptor\r\n', 'b73286ff1a3bb877ad5a70de6457ec58', '2022-11-28 22:04:14', '2022-11-28 22:21:46', 'nacos', '127.0.0.1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (6, 'witos-gen-dev.yml', 'DEFAULT_GROUP', '# spring配置\r\nspring: \r\n  redis:\r\n    host: witos-redis\r\n    port: 6379\r\n    #password: \r\n    timeout: 1000 # 连接超时时间（毫秒）\r\n    jedis:\r\n      pool:\r\n        max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\r\n        max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-idle: 8 # 连接池中的最大  空闲连接\r\n        min-idle: 0 # 连接池中的最小空闲连接\r\n  datasource: \r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://witos-mysql:3306/witos_platform?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\r\n    username: root\r\n    password: 123456\r\n# swagger配置\r\nswagger:\r\n  title: 代码生成接口文档\r\n  license: Powered By witos\r\n  licenseUrl: https://witos.cn\r\n\r\n# 代码生成\r\ngen: \r\n  # 作者\r\n  author: witos\r\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\r\n  packageName: com.witos.system\r\n  # 自动去除表前缀，默认是false\r\n  autoRemovePre: false\r\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\r\n  tablePrefix: sys_\r\n', '373d13719725d85df9184bd6c780092d', '2022-11-28 22:04:14', '2022-11-28 22:24:14', 'nacos', '127.0.0.1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (7, 'witos-file-dev.yml', 'DEFAULT_GROUP', '#本地文件服务的配置迁移到公共配置文件里\n# FastDFS配置 -- http://witos-fastdfs 为hosts映射\nfdfs:\n  domain: http://witos-fastdfs\n  soTimeout: 3000\n  connectTimeout: 2000\n  trackerList: witos-fastdfs:22122\n\n# Minio配置\nminio:\n  url: https://witos-minio\n  accessKey: witos\n  secretKey: witos\n  bucketName: witos', '572501f82ee8211217ef057fdfb37a00', '2022-11-28 22:04:14', '2023-07-22 14:25:50', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (8, 'sentinel-witos-gateway', 'DEFAULT_GROUP', '[\n    {\n        \"resource\": \"witos-auth\",\n        \"count\": 500,\n        \"grade\": 1,\n        \"limitApp\": \"default\",\n        \"strategy\": 0,\n        \"controlBehavior\": 0\n    },\n	{\n        \"resource\": \"witos-system\",\n        \"count\": 1000,\n        \"grade\": 1,\n        \"limitApp\": \"default\",\n        \"strategy\": 0,\n        \"controlBehavior\": 0\n    },\n	{\n        \"resource\": \"witos-gen\",\n        \"count\": 200,\n        \"grade\": 1,\n        \"limitApp\": \"default\",\n        \"strategy\": 0,\n        \"controlBehavior\": 0\n    }\n]', 'c7ec4b61d6ccf685bd25f3abd577e24e', '2022-11-28 22:04:14', '2022-11-28 22:04:14', 'nacos', '127.0.0.1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (9, 'witos-demo-dev.yml', 'DEFAULT_GROUP', '# spring配置\r\nspring: \r\n  redis:\r\n    host: witos-redis\r\n    port: 6379\r\n    #password: \r\n    timeout: 1000 # 连接超时时间（毫秒）\r\n    jedis:\r\n      pool:\r\n        max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\r\n        max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-idle: 8 # 连接池中的最大  空闲连接\r\n        min-idle: 0 # 连接池中的最小空闲连接\r\n  datasource: \r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://witos-mysql:3306/witos_platform?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\r\n    username: root\r\n    password: 123456\r\n# swagger配置\r\nswagger:\r\n  title: 代码生成接口文档\r\n  license: Powered By witos\r\n  licenseUrl: https://witos.cn\r\n\r\nxxl:\r\n  job:\r\n    admin:\r\n      ### xxl-job admin address list, such as \"http://address\" or \"http://address01,http://address02\"\r\n      addresses: http://localhost/dev-api/job\r\n    ### xxl-job, access token\r\n    accessToken: default_token\r\n    executor: \r\n      ### xxl-job executor appname\r\n      appname: xxl-job-executor-sample\r\n      ### xxl-job executor registry-address: default use address to registry , otherwise use ip:port if address is null\r\n      address: \r\n      ### xxl-job executor server-info\r\n      ip: 127.0.0.1\r\n      port: 9999\r\n      ### xxl-job executor log-path\r\n      logpath: ./logs/xxl-job\r\n      ### xxl-job executor log-retention-days\r\n      logretentiondays: 30', '7fa7a4f6f6a52fdf42100837260bb874', '2022-10-26 20:40:11', '2023-04-13 23:57:18', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (10, 'witos-job-dev.yml', 'DEFAULT_GROUP', '# spring配置\r\nspring: \r\n  redis:\r\n    host: witos-redis\r\n    port: 6379\r\n    #password: \r\n    timeout: 1000 # 连接超时时间（毫秒）\r\n    jedis:\r\n      pool:\r\n        max-active: 10 # 连接池最大连接数（使用负值表示没有限制）\r\n        max-wait: -1ms # 连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-idle: 8 # 连接池中的最大  空闲连接\r\n        min-idle: 0 # 连接池中的最小空闲连接\r\n  datasource: \r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://witos-mysql:3306/witos_platform?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\r\n    username: root\r\n    password: 123456\r\n  mail:\r\n    host: www.163.com\r\n    port: 25\r\n    username: xxxxxx@163.com\r\n    from: xxxxxx@163.com\r\n    password: xxxxxx\r\n    properties: \r\n      mail: \r\n        smtp: \r\n          auth: false\r\n          starttls: \r\n            enable: false\r\n            required: false\r\n          socketFactory: \r\n            class: javax.net.ssl.SSLSocketFactory\r\n          \r\n# swagger配置\r\nswagger:\r\n  title: 定时任务接口文档\r\n  license: Powered By witos\r\n  licenseUrl: https://witos.cn\r\n\r\nxxl:\r\n  job:\r\n    accessToken: default_token\r\n    i18n: zh_CN\r\n    logretentiondays: 30\r\n    triggerpool: \r\n      fast: \r\n        max: 200\r\n      slow: \r\n        max: 100\r\n\r\ncustom:\r\n  log:\r\n    list:\r\n      - scheduleJobQuery-error\r\n      - findFailJobLogIds-error\r\n      - findByAddressType-error\r\n\r\n\r\n', '2caec7ca88cc94a5264ea2062a45b672', '2022-10-27 21:22:25', '2023-04-27 23:52:14', 'nacos', '192.168.2.12', '', '', '', '', '', 'yaml', '', '10');
-- ----------------------------
