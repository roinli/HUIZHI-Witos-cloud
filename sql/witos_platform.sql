...
*/
DROP DATABASE IF EXISTS `witos_platform`;

CREATE DATABASE  `witos_platform` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `gen_table` VALUES (1, 'sys_role', '角色信息表', NULL, NULL, 'SysRole', 'crud', 'com.witos.system', 'system', 'role', '角色信息', 'witos', '0', '/', '{}', 'admin', '2022-03-07 19:28:14', '', '2023-04-13 19:09:44', NULL);
...
INSERT INTO `gen_table` VALUES (9, 'xxl_job_group', '定时任务分组', NULL, NULL, 'XxlJobGroup', 'crud', 'com.witos.job', 'job', 'group', '定时任务分组', 'witos', '0', '/', '{\"parentMenuId\":2044}', 'admin', '2022-11-01 22:31:19', '', '2023-01-01 01:04:30', NULL);
INSERT INTO `gen_table` VALUES (10, 'xxl_job_info', '定时任务信息', NULL, NULL, 'XxlJobInfo', 'crud', 'com.witos.job', 'job', 'info', '任务', 'witos', '0', '/', '{\"parentMenuId\":2044}', 'admin', '2022-11-01 22:31:19', '', '2022-11-01 22:36:52', NULL);
INSERT INTO `gen_table` VALUES (11, 'xxl_job_lock', '', NULL, NULL, 'XxlJobLock', 'crud', 'com.witos.system', 'system', 'lock', NULL, 'witos', '0', '/', NULL, 'admin', '2022-11-01 22:31:20', '', NULL, NULL);
INSERT INTO `gen_table` VALUES (12, 'xxl_job_log', '定时任务日志', NULL, NULL, 'XxlJobLog', 'crud', 'com.witos.job', 'job', 'log', '定时任务日志', 'witos', '0', '/', '{\"parentMenuId\":2044}', 'admin', '2022-11-01 22:31:20', '', '2023-01-03 21:00:53', NULL);
INSERT INTO `gen_table` VALUES (13, 'xxl_job_log_report', '报告', NULL, NULL, 'XxlJobLogReport', 'crud', 'com.witos.job', 'job', 'report', '报告', 'witos', '0', '/', '{}', 'admin', '2022-11-01 22:31:20', '', '2023-01-03 22:23:34', NULL);
INSERT INTO `gen_table` VALUES (14, 'xxl_job_logglue', '', NULL, NULL, 'XxlJobLogglue', 'crud', 'com.witos.system', 'system', 'logglue', NULL, 'witos', '0', '/', NULL, 'admin', '2022-11-01 22:31:20', '', NULL, NULL);
INSERT INTO `gen_table` VALUES (15, 'xxl_job_registry', '注册', NULL, NULL, 'XxlJobRegistry', 'crud', 'com.witos.job', 'job', 'registry', '注册', 'witos', '0', '/', '{\"parentMenuId\":2044}', 'admin', '2022-11-01 22:31:21', '', '2023-01-03 11:08:57', NULL);
INSERT INTO `gen_table` VALUES (16, 'xxl_job_user', '', NULL, NULL, 'XxlJobUser', 'crud', 'com.witos.system', 'system', 'user', NULL, 'witos', '0', '/', NULL, 'admin', '2022-11-01 22:31:21', '', NULL, NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='代码生成业务表字段';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='缓存列表';
...
CREATE TABLE `monitor_sys` (
  ...
  `tenant_id` bigint(20) NOT NULL COMMENT '租户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统监控表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统监控信息记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='参数配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='测试表';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` VALUES (100, 0, '0', 'witos科技', 0, '数智化部管理员', '13851202705', 'dhr92@163.com', '0', '0', 'admin', '2022-03-07 15:41:18', 'admin', '2022-06-11 00:49:10', 9999);
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', 'witos集团', 1, '数智化部管理员', '13851202705', 'dhr92@163.com', '0', '0', 'admin', '2022-03-07 15:41:18', 'admin', '2022-06-11 00:49:02', 9999);
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=2044 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单权限表';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_notice` VALUES (1, '温馨提醒：2018-07-01 witos新版本发布啦', '2', 0xE696B0E78988E69CACE58685E5AEB9, '0', 'admin', '2022-03-07 15:41:18', 'admin', '2022-03-07 18:36:11', '管理员', 9999);
INSERT INTO `sys_notice` VALUES (2, '维护通知：2018-07-01 witos系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', '2022-03-07 15:41:18', '', NULL, '管理员', 9999);
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (1, 1, '测试任务1', '2018-11-03 22:21:31', '2023-04-13 20:37:54', '迪卢克', 'witos_master@163.com', 'CRON', '0/10 * * * * ? *', 'DO_NOTHING', 'FIRST', 'demoJobHandler', '222', 'COVER_EARLY', 60, 0, 'BEAN', '', 'GLUE代码初始化', '2018-11-03 00:00:00', NULL, 0, 0, 0, 9999);
