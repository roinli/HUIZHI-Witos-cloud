...
import com.witos.system.service.ISysDeptService;
...
public class SysRoleController extends BaseController
{
    ...
    {
        IPage<SysRole> list = roleService.selectRolePage(role);
    ...
    {
        IPage<SysUser> list = userService.selectAllocatedList(user);
        return AjaxResult.success(list);
    }
    ...
    {
        IPage<SysUser> list = userService.selectUnallocatedList(user);
        return AjaxResult.success(list);
    }
